...
--Step 3. Delete Department and other manual tasks
...
Select E.[EmployeeID], 
	   ...
	   E.[DepartmentID], E.[Position], E.[Salary], E.[SalaryAfterRaise], E.[OTBonus], E.[NewEmployee],
...
---C----
--USE SUBquery to finds the maximum salary for each department by matching DepartmentID in the subquery (Sub) with the outer query (E).

Select CONCAT_WS (' ', E.[FirstName], E.[LastName]) AS [Employee Full Name], 
   	   E.[SalaryAfterRaise] AS [Salary], D.[DepartmentName]
...
ON E.DepartmentID = D.DepartmentID
	...
	Where 
		D.DepartmentID IS NOT NULL AND
...
--    COMMIT TRANSACTION;
--    PRINT 'Transaction committed successfully. Salaries updated.';
--END TRY
--BEGIN CATCH
